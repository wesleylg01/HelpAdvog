...
salvar_processo;
//Liberando o botão que salva faz o processo de liberar a parte de salvar imagens
...
begin
//Limpenado os campos e dando foco ao edite da petição
Edit_peticao.Clear;
Edit_numvara.Clear;
Edit_reu.Clear;
Edit_autor.Clear;
...
begin
  {
    ...
    Ativando os botões, e o edit das paginas
  }
